...
dirname = 'CRABtasks_Sum' ## If we want to change this then we should make it an ARG so we can edit name is script below
...
config.JobType.inputFiles = ['crab_script_%s.py' % ( idname), '../../scripts/haddnano.py', '../../scripts/keep_and_drop_input.txt', '../../scripts/keep_and_drop_output.txt']
...
modulesList.append(countHistogramsModule())
#mvareader = topLeptonMVA2017
