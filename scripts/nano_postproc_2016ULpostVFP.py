...
# python nano_postproc_2016ULpostVFP.py . ../../NanoAOD/test/2016postVFP_SAMPLE.root
...
jmeCorrections = createJMECorrector(True, 'UL2016', '', 'Total', 'AK4PFchs')
modulesList.append(jmeCorrections())
modulesList.append(btagSFUL2016())
p = PostProcessor('.',
                  inputFiles(),
                  cut,
                  modules=modulesList,
